...
{
	DEBUG_REPORT("RW map-value-wrapper");
...
{
	DEBUG_REPORT("RO map-value-wrapper");
	visitEveryObject< std::map<K,V>,std::pair<const K,V> >(
			mapOfObjs.cbegin(),
			mapOfObjs.cend(),
