 ...
 *   sum=mean+d_compensated							//this potentially loses
 * low-order
 * bits compensation=(sum-mean) - d_compensated		//recovers what's been lost
 * and adds it in the next round,
 *   															//algebraically,
 * 'compensation' should be zero mean=sum endfor \endverbatim
 *
 ...
 * Literature:
 *
 * [1] Kahan, William (January 1965), "Further remarks on reducing truncation
